...
public class WarnetDao {
    private List<Warnet1> data = new ArrayList();
    ...
    public WarnetDao(){
     ...
     public void insert(Warnet1 warnet){
        data.add(warnet);
    }
    
    public void update(int index, Warnet1 warnet){
    ...
    public Warnet1 getWarnet(int index){
        return data.get(index);
    }
    
    public List<Warnet1> getAll(){
        return data;
    }
