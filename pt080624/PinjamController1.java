 ...
 * @author user
 */
public class PinjamController1 {
    private formPinjam1 form;
    private List<Pinjam1> data;
    private SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");

    public PinjamController1(formPinjam1 form) {
        this.form = form;
        data = new ArrayList<>();
    }
    ...
    public void tampil() {
        ...
        DefaultTableModel model = (DefaultTableModel) form.getTblPinjam().getModel();
    ...
    public void savePinjam() {
        try {
            ...
            Pinjam1 pinjam = new Pinjam1(kodeAnggota, kodeBuku, tglPinjam, tglKembali, terlambat, dendaTotal);
            data.add(pinjam);
            tampil();
            clearForm();
    ...
    public void getPinjam() {
        ...
        int selectedRow = form.getTblPinjam().getSelectedRow();
        if (selectedRow != -1) {
            Pinjam1 pinjam = data.get(selectedRow);
    ...
    public void calculateTerlambatAndDenda(){
        try {
            ...
            JOptionPane.showMessageDialog(form, "Format tanggal salah. Gunakan format dd-MM-yyyy.");
        }
    }
}
